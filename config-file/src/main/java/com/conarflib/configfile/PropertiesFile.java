...
>>>>>>> b3937a6 (Rename module from file-configuration to config-file, and adjusted the path class name):config-file/src/main/java/com/conarflib/configfile/PropertiesFile.java
