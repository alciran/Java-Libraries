...
>>>>>>> b3937a6 (Rename module from file-configuration to config-file, and adjusted the path class name):config-file/src/main/java/com/conarflib/configfile/IniConfigurationFile.java
    ...
    private Map<String, String> getAllEncryptedSection(String sectionName, String secretKey) {
        ...
        getSectionProperties(sectionName)
                .forEach((key, value) -> mapProperties.put(key, symmetricDecrypt(value, secretKey)));
        return mapProperties;
    }

    private Map<String, String> getEncryptedSectionByList(String sectionName, String secretKey,
